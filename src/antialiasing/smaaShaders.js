// SMAA 1x Medium, color edge detection. Ported from three.js r158 SMAAShader.
// SMAA 2.8: https://github.com/iryoku/smaa/releases/tag/v2.8
// Copyright notices and licenses: public/rendering/smaa/LICENSE.txt.
// Cesium GLSL 300 plumbing; original WebGL offsets and Y signs are preserved.

export const edgesShader = /* glsl */`
...
void main() {
	...
	out_FragColor = SMAAColorEdgeDetectionPS( vUv, vOffset, colorTexture );

}
`

export const weightsShader = /* glsl */`
#define SMAA_MAX_SEARCH_STEPS 8
#define SMAA_AREATEX_MAX_DISTANCE 16
#define SMAA_AREATEX_PIXEL_SIZE ( 1.0 / vec2( 160.0, 560.0 ) )
#define SMAA_AREATEX_SUBTEX_SIZE ( 1.0 / 7.0 )
// float(offset) and the two crossing-edge Y adjustments below are paired upstream.
...
void main() {
	...
	out_FragColor = SMAABlendingWeightCalculationPS( vUv, vPixcoord, vOffset, tDiffuse, tArea, tSearch, ivec4( 0.0 ) );

}
`

export const blendShader = /* glsl */`
uniform sampler2D tDiffuse;
uniform sampler2D colorTexture;
uniform vec2 resolution;
...
void main() {
	...
	out_FragColor = SMAANeighborhoodBlendingPS( vUv, vOffset, colorTexture, tDiffuse );
